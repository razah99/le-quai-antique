...
<footer id="hourly" class="footer mx-auto">
    ...
    <div class="d-flex flex-wrap justify-content-around align-items-center">
        ...
        <table class="table m-5">
            <thead>
                <tr>
                    <th scope="col" colspan="2" class="text-center p-5">
    ...
    <ul class="feet nav justify-content-center p-3" style="font-weight: bold;">
        <li class="nav-item">
            <a class="nav-link link-warning link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="../index.php">Accueil</a>
        </li>
        <li class="nav-item">
            <a class="nav-link link-warning link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="menu.php">Voir la carte</a>
        </li>
        <li class="nav-item">
            <a class="nav-link link-warning link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="reservation.php">Réserver une table</a>
        </li>
        <li class="nav-item">
